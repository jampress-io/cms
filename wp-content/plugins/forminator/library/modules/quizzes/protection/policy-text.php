<div class="wp-suggested-text">
	...
	<p class="privacy-policy-tutorial">
		<?php _e( 'By default Forminator captures <strong>NO Personally Identifiable Information</strong> for each Quiz submission.', 'forminator' );// wpcs: xss ok. ?>
	</p>
	<p class="privacy-policy-tutorial">
		<?php esc_html_e(
	...
	<p>
		...
		<?php _e( 'When visitors or users submit a quiz\'s answer, we capture <strong>NO Personally Identifiable Information</strong>.', 'forminator' );// wpcs: xss
		// ok. ?>
	</p>
	...
	<p>
		<strong class="privacy-policy-tutorial"><?php esc_html_e( 'Suggested text: ', 'forminator' ); ?></strong>
		<?php _e( 'When visitors or users answer a quiz we retain the <strong>answers</strong> data for 30 days and then remove it from our system.', 'forminator' ); // wpcs: xss ok. ?>
	</p>
