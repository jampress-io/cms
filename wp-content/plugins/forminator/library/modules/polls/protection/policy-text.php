<div class="wp-suggested-text">
	...
	<p class="privacy-policy-tutorial">
		<?php _e( 'By default Forminator captures the <strong>IP Address</strong> for each Poll submission.', 'forminator' );// wpcs: xss ok. ?>
	</p>
	<p class="privacy-policy-tutorial">
	...
	<p>
		...
		<?php _e( 'When visitors or users submit a poll, we capture the <strong>IP Address</strong> for spam protection and to set voter limitations.', 'forminator' );// wpcs: xss ok. ?>
	</p>
	...
	<p class="privacy-policy-tutorial">
		...
		<strong>Privacy Settings</strong>',
		          'forminator' );// wpcs: xss ok. ?>
	</p>
	<p>
		<strong class="privacy-policy-tutorial"><?php esc_html_e( 'Suggested text: ', 'forminator' ); ?></strong>
		<?php _e( 'When visitors or users votes on a poll we retain the <strong>IP Address</strong> data for 30 days and anonymize it.', 'forminator' ); // wpcs: xss ok. ?>
	</p>
