...
"User Role" => array( null, __("User Role", "forminator" ), ), // src/form/components/registration/meta-mapping.js:51
...
"Choose which user role you want to assign to the visitors signing up. You can either assign a fixed user role to all of them or assign a user role conditionally, based on their response to the form fields." => array( null, __("Choose which user role you want to assign to the visitors signing up. You can either assign a fixed user role to all of them or assign a user role conditionally, based on their response to the form fields.", "forminator" ), ), // src/form/components/registration/meta-mapping.js:174
"Fixed Role to All" => array( null, __("Fixed Role to All", "forminator" ), ), // src/form/components/registration/meta-mapping.js:184
"Assign Role Conditionally" => array( null, __("Assign Role Conditionally", "forminator" ), ), // src/form/components/registration/meta-mapping.js:204
"No custom user meta created yet. Click on \"+ Add Custom User Meta\" to create custom user meta and map form fields to it." => array( null, __("No custom user meta created yet. Click on \"+ Add Custom User Meta\" to create custom user meta and map form fields to it.", "forminator" ), ), // src/form/components/registration/meta-mapping.js:211
"Custom User Meta" => array( null, __("Custom User Meta", "forminator" ), ), // src/form/components/registration/meta-mapping.js:220
"Create custom user meta keys and assign your form fields to them to set additional user meta keys on successful user registration." => array( null, __("Create custom user meta keys and assign your form fields to them to set additional user meta keys on successful user registration.", "forminator" ), ), // src/form/components/registration/meta-mapping.js:222
"Add Custom User Meta" => array( null, __("Add Custom User Meta", "forminator" ), ), // src/form/components/registration/meta-mapping.js:234
...
"Delete option" => array( null, __("Delete option", "forminator" ), ), // src/form/components/settings/multi-option.js:95
"Submission limit" => array( null, __("Submission limit", "forminator" ), ), // src/form/components/settings/multi-option.js:114
...
"Add User Role" => array( null, __("Add User Role", "forminator" ), ), // src/form/components/settings/user-role.js:165
...
"Participants can choose multiple answers with \"on submission\" method." => array( null, __("Participants can choose multiple answers with \"on submission\" method.", "forminator" ), ), // src/quiz/global/components/behaviour/results.js:57
...
"Skip form button" => array( null, __("Skip form button", "forminator" ), ), // src/quiz/knowledge/components/appearance/colors/basic.js:74
...
"Something went wrong." => array( null, __("Something went wrong.", "forminator" ), ), // src/settings/containers/layout/meta-dropdown.js:80
...
"is final result" => array( null, __("is final result", "forminator" ), ), // src/utils.js:925
"is not final result" => array( null, __("is not final result", "forminator" ), ), // src/utils.js:927
);
